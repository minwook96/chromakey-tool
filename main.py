...
def create_chromakey(images_path, background_path, location_type):
    # img 파일만 가져오기
...
def authors():
    ...
    """
    console.print("[bold]Chroma key Tool (skysys)[/bold] email [bold magenta]skysys@skysys.co.kr[/bold magenta] tel [bold red]052) 707-7561 [/bold red]")
...
def init(default):
    ...
    if default:
        ...
        # console.clear()
        create_chromakey(images_path, background_path, location_type)
